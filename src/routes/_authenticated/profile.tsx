  ...
  return (
    <AppShell>
      <div className="px-6 pt-14">
        ...
        <button
          onClick={signOut}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl border border-border bg-surface py-4 text-sm font-semibold text-destructive"
        >
          <LogOut className="h-4 w-4" /> Sign out
        </button>
        <p className="mt-6 text-center text-[10px] uppercase tracking-[0.32em] text-muted-foreground/60">
          ATHLYT · v1.0
        </p>
        <div className="h-10" />
      </div>
