  ...
  return (
    <div className="mx-auto min-h-[100dvh] max-w-[480px] px-6 pb-10 pt-12">
      ...
      <div className="mt-8 flex items-center gap-2">
        ...
        <p className="text-[11px] uppercase tracking-[0.3em] text-primary">ATHLYT Pro</p>
      </div>
      <h1 className="mt-3 text-[34px] font-semibold tracking-tight leading-tight text-balance">
      ...
      <div className="mt-8 space-y-3">
        {plans.map((p) => (
          <button
            ...
            className={`flex w-full items-center justify-between rounded-2xl border px-5 py-4 ${pick === p.id ? "border-primary bg-primary/10" : "border-border bg-surface"}`}
          >
      ...
      <button
        onClick={() =>
          toast.success("Subscription will be available soon", {
            description: "Payments integration pending.",
          })
        }
        className="mt-8 w-full rounded-full bg-primary py-4 text-[15px] font-semibold text-primary-foreground"
      >
