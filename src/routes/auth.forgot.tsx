...
function Forgot() {
  ...
  return (
    <div className="mx-auto min-h-[100dvh] max-w-[480px] px-6 pb-10 pt-12">
      <Link to="/auth/signin" className="grid h-10 w-10 place-items-center rounded-full bg-surface">
      ...
      {sent ? (
        ...
        <>
          <h1 className="mt-8 text-[34px] font-semibold tracking-tight leading-tight">
            Reset password
          </h1>
          ...
          <form onSubmit={submit} className="mt-10 space-y-4">
            ...
            <button
              disabled={loading}
              className="mt-2 w-full rounded-full bg-primary py-4 text-[15px] font-semibold text-primary-foreground disabled:opacity-60"
            >
